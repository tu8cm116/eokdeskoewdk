...
main_menu.add(KeyboardButton("Мой ID"))
    ...
    try:
        ...
        async with db_pool.acquire() as conn:
            ...
            try:
                ...
                pass
        log.info("PostgreSQL подключён и таблицы готовы")
        return True
